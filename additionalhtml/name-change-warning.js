...
if (page.match('/user/edit.php') || page.match('/user/editadvanced.php')) {
    let showNameChangeWarning = (ev) => {
        const html = '<div class="col-md-9 alert alert-primary" style="margin:6px;">We recommend notifying your instructors or students after changing your name, to avoid any confusion.</div>'
