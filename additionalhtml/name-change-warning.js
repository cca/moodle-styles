...
if (page.match('/user/edit.php') || page.match('/user/editadvanced.php')) {
    ...
    div.innerHTML = '<p class="col-md-9 alert alert-primary" style="margin:6px;"><button type="button" class="close" data-dismiss="alert">×</button> Your name and email come from Workday and cannot be edited here. <a href="https://portal.cca.edu/essentials/workday-student/my-profile-information/updating-name-and-personal-information-step-step-guide/#-edit-your-preferred-name-">See Portal for information on changing your preferred name</a>.</p>'
